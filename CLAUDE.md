...
- Always remember the output of the traslation from the LLMs should be feed into the evaluation piepline to check if the rag help improving the performence, don't do post-processingwork, like teak the output from LLMS in order to improve the performence.
